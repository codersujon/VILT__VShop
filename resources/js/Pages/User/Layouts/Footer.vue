...
<template lang="">
    ...
    <footer
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {{ year }} <a
                href="https://codersujon.com/" class="hover:underline" target="_blank">VShop</a>. All Rights Reserved.
        </span>
